...
export default function Contact() {
    ...
    return (
        <section id="contact" className="relative">
            ...
            <div className="w-full lg:w-2/3 md:w-1/2 border-4 bg-white border-white border-hidden rounded overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
                <iframe
                width="100%"
                height="100%"
                title="map"
            ...
            <form
                ...
                className="lg:w-1/3 md:w-1/2 flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0 border-4 bg-white border-white rounded px-5 py-5">
                <h2 className="text-black sm:text-4xl text-3xl mb-1 font-medium title-font">
                Hire Me
                </h2>
                <p className="leading-relaxed mb-5">
                Use the form below to get in touch and I will get back to you soon!
                </p>
                ...
                <button
                type="submit"
                className="text-white bg-orange-500 border-0 py-2 px-6 focus:outline-none btn-purple text-lg">
                Submit
                </button>
            </form>
            </div>
